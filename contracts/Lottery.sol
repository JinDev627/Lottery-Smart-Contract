...
contract Lottery {
    ...
    /**
     * @dev Check betting info - user send 0.5ETH, and one byte
     */
    ...
    /**
     * @dev confirm the betting result
     */
    ...
    /**
     * @dev Confirm the betting character and block hash
     */
    ...
    function pushBet(byte challenges) internal returns (bool) {
        ...
        _bets[_tail] = b;
        _tail++; // 32byte Value // 20000 gas -> 5000 gas
